...
public class UserServiceTest {
    ...
    @Test
    void searchUserByTagName() {
        List<String> tags=Arrays.asList("java","python");
        List<User> userList = userService.searchUserByTagName(tags);
        Assert.assertNotNull(userList);
        Assert.assertFalse("应该找到匹配的用户数据", userList.isEmpty());
    }
}